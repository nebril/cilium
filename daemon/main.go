...
func init() {
	...
	flags.Bool(
		"auto-v6-l3-routes", false, "Automatically adds IPv6 L3 routes to reach other nodes for non-overlay mode (--device) (BETA)")
...
func initEnv() {
	...
	config.AutoV6L3Routes = viper.GetBool("auto-v6-l3-routes")
